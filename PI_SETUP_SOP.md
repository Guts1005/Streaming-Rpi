...
```bash
wget -O setup_pi.sh https://raw.githubusercontent.com/Guts1005/Streaming-Rpi/main/setup_pi.sh?token=YOUR_RAW_GITHUB_URL_TOKEN_HERE
bash setup_pi.sh
```
...
The script is interactive for the first 30 seconds. It will ask you:
...
2. **LiveKit Credentials**: You will be prompted to paste your `LIVEKIT_URL`, `LIVEKIT_API_KEY`, and `LIVEKIT_API_SECRET`. The script will auto-generate the `.env` file securely.

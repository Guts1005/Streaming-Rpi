...
type ViewMode = 'dashboard' | 'object-detection' | 'face-detection' | 'safety-alerts' | 'customers';
    ...
    <div className="app-container">
      ...
      <aside className={`sidebar ${sidebarOpen ? 'sidebar-open' : ''}`}>
        ...
        <nav className="nav-section">
          ...
          <button className={`nav-item ${currentView === 'customers' ? 'active' : ''}`} onClick={() => handleNavClick('customers')}>
      ...
      <main className="main-area">
        <header className="topbar">
          ...
          <div className="topbar-actions">
            ...
            <div className="user-profile" onClick={handleLogout} style={{ cursor: 'pointer' }} title="Logout">
        ...
        {currentView === 'customers' ? (
          ...
          <div className="dashboard-grid">
            ...
            <div className="right-col">
              ...
              {dashboardStats && (
                <div className="panel" style={{ display: 'flex', justifyContent: 'space-between', flexWrap: 'wrap', gap: '12px' }}>
                  <div style={{ textAlign: 'center', flex: 1, borderRight: '1px solid #1e293b' }}>
                    <h4 style={{ fontSize: '20px', margin: '0 0 4px', color: '#60a5fa' }}>{dashboardStats.total_customers}</h4>
                    <p style={{ margin: 0, fontSize: '11px', color: 'var(--text-muted)' }}>Total Customers</p>
                  </div>
                  <div style={{ textAlign: 'center', flex: 1, borderRight: '1px solid #1e293b' }}>
                    <h4 style={{ fontSize: '20px', margin: '0 0 4px', color: '#34d399' }}>{dashboardStats.active_customers}</h4>
                    <p style={{ margin: 0, fontSize: '11px', color: 'var(--text-muted)' }}>Active Customers</p>
                  </div>
                  <div style={{ textAlign: 'center', flex: 1 }}>
                    <h4 style={{ fontSize: '20px', margin: '0 0 4px', color: '#c084fc' }}>{dashboardStats.device_assignments}</h4>
                    <p style={{ margin: 0, fontSize: '11px', color: 'var(--text-muted)' }}>Assigned Devices</p>
                  </div>
                </div>
              )}

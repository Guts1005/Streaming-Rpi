...
const formColumns: ColumnDef[] = [
  ...
  { key: 'site_name', label: 'Site Name', type: 'varchar' },
  { key: 'address', label: 'Address', type: 'text' },
  { key: 'dlvry_address', label: 'Delivery Address', type: 'text' },
  { key: 'client_mail', label: 'Client Mail', type: 'varchar' },
  { key: 'contact_person1', label: 'Contact Person 1', type: 'varchar' },
  { key: 'contact_person1_mobile', label: 'Contact 1 Mobile', type: 'varchar' },
  { key: 'contact_person1_mail', label: 'Contact 1 Email', type: 'varchar' },
  { key: 'contact_person2', label: 'Contact Person 2', type: 'varchar' },
  { key: 'contact_person2_mobile', label: 'Contact 2 Mobile', type: 'varchar' },
  { key: 'contact_person2_mail', label: 'Contact 2 Email', type: 'varchar' },
  { key: 'actv', label: 'Active', type: 'varchar' },
  { key: 'boq_amount', label: 'BOQ Amount', type: 'varchar' },
  { key: 'pmc', label: 'PMC', type: 'varchar' },
  { key: 'from_date', label: 'From Date', type: 'date' },
  { key: 'end_date', label: 'End Date', type: 'date' },
  { key: 'HOD', label: 'HOD Date', type: 'date' },
  { key: 'fl', label: 'FL', type: 'text' },
  { key: 'company_logo', label: 'Company Logo URL', type: 'text' },
  { key: 'PMC_logo', label: 'PMC Logo URL', type: 'text' },
  { key: 'our_logo', label: 'Our Logo URL', type: 'text' },
  { key: 'graph', label: 'Graph', type: 'varchar' },
  { key: 'max_permissible_indents', label: 'Max Permissible Indents', type: 'int' },
  { key: 'boq_added', label: 'BOQ Added', type: 'varchar' },
  { key: 'sft', label: 'SFT', type: 'varchar' },
  { key: 'purchase_sft', label: 'Purchase SFT', type: 'varchar' },
  { key: 'internal', label: 'Internal', type: 'varchar' },
  { key: 'ongoing', label: 'Ongoing', type: 'varchar' },
  { key: 'sft_block', label: 'SFT Block', type: 'varchar' },
  { key: 'feedback', label: 'Feedback', type: 'varchar' },
  { key: 'device_id', label: 'Device ID', type: 'varchar' }
];
